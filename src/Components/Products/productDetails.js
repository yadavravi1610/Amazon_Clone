...
const ProductDetails = () => {
  ...
  return (
    <div className='flex xs:flex-col mdl:flex-row gap-2 bg-white justify-between'>
      <ScrollRestoration />
      <div className='xs:hidden lgl:block lgl:w-[5%] mt-10 ml-1 sticky'>
      ...
      <div className='w-full lgl:w-[20%] h-[430px] border-[0.066rem] border-gray-200 rounded-lg p-5 mt-2 mr-1'>
        ...
        <div className=''>
          {cartButton
            ? <Link to="/Cart">
              <button className={`pt-2 xs:w-[45%] lgl:w-full text-center text-blue-600 rounded-2xl  bg-gray-100 border-gray-200 p-[4px] mt-3 active:ring-2     active:ring-offset-1 active:ring-blue-600`}>
                Go to Cart
              </button>
            </Link>
            : <button
              ...
              className={`pt-2 xs:w-[45%] lgl:w-full text-center rounded-2xl bg-yellow-300 hover:bg-yellow-400 p-[4px] mt-3 shadow active:ring-2 active:ring-offset-1 active:ring-blue-500`}>
              Add to Cart
            </button>}
          {
            authenticated
              ? <Link to="/checkout">
                <button
                  ...
                  className={`pt-2 xs:ml-5 lgl:ml-0 xs:w-[45%] lgl:w-full text-center rounded-2xl bg-orange-400 hover:bg-orange-500 p-[4px] mt-3 shadow active:ring-2 active:ring-offset-1 active:ring-blue-500`}>
                  Buy Now
                </button>
              </Link>
              : <Link to="/signIn">
                <button
                  className={`pt-2 xs:ml-10 lgl:ml-0 xs:w-[45%] lgl:w-full text-center rounded-2xl bg-orange-400 hover:bg-orange-500 p-[4px] mt-3 shadow active:ring-2 active:ring-offset-1 active:ring-blue-500`}>
                  Buy Now
                </button>
              </Link>
          }
